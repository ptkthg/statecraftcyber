...
export default function Footer() {
  return (
    <footer className="bg-canvas border-t border-white/5 mt-auto">
          ...
          <div className="flex gap-16">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/threat-briefings" className="text-sm text-dim hover:text-white transition-colors">
                    Threat Briefings
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/iocs" className="text-sm text-dim hover:text-white transition-colors">
                    Busca de IOCs
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/sobre" className="text-sm text-dim hover:text-white transition-colors">
                    Sobre a Statecraft
                  </Link>
                </li>
                <li>
                  <Link href="/metodologia" className="text-sm text-dim hover:text-white transition-colors">
                    Metodologia
                  </Link>
                </li>
                <li>
                  <a href="mailto:contato@statecraft.com.br" className="text-sm text-dim hover:text-white transition-colors">
                    Contato
                  </a>
                </li>
              </ul>
